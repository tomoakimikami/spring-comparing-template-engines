...
public class PresentationsController {
  ...
  private List<Presentation> findAll() {
    ...
    for (int i = 0; i < 10; i++) {
      list.addAll(presentations.values());
    }
    return list;
